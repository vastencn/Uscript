...
$brak_default_spelling="agen";

//a defintion of the brakets menaing
$brak_text_def = 	"agen brak\n".
				  	"";



function agen_brak($chunk,$cup_depth=13,$hpad=3,$vpad=2,$stroke_width=2){
  ...
  $svg_str.=draw_svg_symbol(@$chunk['svg'],$bboxoff/2,$chunk_x_offset);
  ...
  $btopline=0-(($height/2)+$bboxoff);
  $bbotline=$btopline+($bboxheight-1);
  $bvline1=$inner_space_width/4;
  ...
  $nchunk['drawn']=TRUE;
  $nchunk['height']=$height+$stroke_width+$bboxheight;
