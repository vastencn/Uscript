...
$brak_default_spelling="evalneg";

//a defintion of the brakets menaing
$brak_text_def =  "the false evaluation braket\n".
          "it looks like a normal braket with an embeded cicle\n".
          "the circle radical encompansses many meanings, including space, zero, false.. \n".
          "here it represents \"flase\"\n".
          "it evaluate the inverted value of the eval() brak, the same as !\"invert eval(x)\"\n".
          "the evalneg braket reduces its contents to a true or false value\n";



function evalneg_brak($chunk,$dot_radius=7,$cup_depth=10,$hpad=3,$vpad=2,$stroke_width=2){
  ...
  //draw open
  $svg_str.=evalneg_brak_draw_open($dot_radius,$height,$cup_depth);
...
function evalneg_brak_draw_open($dot_radius=6,$cup_width=10,$cup_depth=5,$stroke_width=2){
  $nsvg="";

  $nsvg.=svg_hcup($dot_radius,0,$cup_width,0-$cup_depth,$stroke_width);
  $nsvg.=svg_circle($dot_radius,0,$dot_radius-$stroke_width/2,$stroke_width,"white");
