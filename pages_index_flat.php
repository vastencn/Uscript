...
<body>
<table border=0><tr><td colspan=2><font size=4>This is a flat version of a UI system for an interactive UI<br>Uscript is a very long term project. Work in progress.<br>Uscript is a self-defining universal language<br>Prerequisites are 'capable 2D surface perception' and 'particle physics level of tech'<br>.<br>For more about the concept, goal, and previous versions check out the pdfs from previous 'failed attempts' on the main page <a href=http://dscript.org>dscript.org</a><br>(they 'failed' because it it grew too large to manage and became a spaghettified  mess of edits)<br>This is the third pass. Previous versions imploded under the weight of cluttered folders, flat files, dependency mistakes, etc...<br>So I built a framework for the development process<br>It has already started slowly creeping up into 'language' from the lower levels of math / physics/ procedural<br>.<br>There is a full interactive UI for designing pages<br>There is a markup language, image drawing system, modular library of symbols, modular bracketing system, etc..<br>But I don't think it's web-safe. Too many file operations (create, delete, edit functions lal over). <br>It's probably exploitable by bad actors so I only post a flat version on my website<br><a href=https://github.com/vastencn/Uscript>github.com/vastencn/Uscript</a><br>documentation minimal and missing chunks. Feel free to ask me if you have any questions m@dscript.org</td></tr><tr><td><img src=img/ui_001.jpg></td><td><img src=img/ui_002.jpg></td></tr><table>
